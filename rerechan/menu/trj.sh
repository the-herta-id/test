...
show_Trojan_menu() {
    clear
    echo -e "${BB}————————————————————————————————————————————————————————${NC}"
    echo -e "           c ${WB}----- [ Trojan Menu ] -----${NC}            "
    echo -e "${BB}————————————————————————————————————————————————————————${NC}"
    echo -e " ${MB}[1]${NC}•${LIGHT}Add Trojan Ws${NC}"
    echo -e " ${MB}[2]${NC}•${LIGHT}Add Trojan Grpc${NC}"
    echo -e " ${MB}[3]${NC}•${LIGHT}Add Trojan Http Upgrade${NC}"
    echo -e " ${MB}[4]${NC}•${LIGHT}Add Trojan TCP${NC}"
	echo -e " ${MB}[5]${NC}•${LIGHT}Add Trojan Bundle${NC}"
...
handle_Trojan_menu() {
    ...
    case $opt in
        ...
        7) clear ; menu-akun ;;		
        0) clear ; menu ;;
        *) echo -e "${YB}Invalid input${NC}" ; sleep 1 ; show_Trojan_menu ;;
    esac
}
