...
🔑 Trojan 
a.) path HTTP Upgrade: /trojan-http

Config URL :

-==============================-

1.) Trojan-HUpgrade TLS
${trojanlink5}

2.) Trojan-HUpgrade nonTLS
${trojanlink6}
...
clear
echo -e "=======-XRAY/TROJAN-HTTPUPGRADE======="
echo -e ""
echo -e "Remarks: ${user}"
...
echo -e "================================="
echo -e "path: "
echo -e "a.) HTTP Upgrade: /trojan-http"
echo -e "================================="
echo -e "alpn: http/1.1"
echo -e "================================="
echo -e "tls: true / false"
