...
# Link VLess
vlesslink5="vless://${uuid}@${domain}:443?security=tls&type=httpupgrade&host=${domain}&headerType=&path=%2Fvless-http&sni=&fp=&alpn=http%2F1.1#%28${user}%29%20%5BVLESS%20-%20HTTPUpgrade%5D%20TLS"
vlesslink6="vless://${uuid}@${domain}:80?security=none&type=httpupgrade&host=${domain}&headerType=&path=%2Fvless-http#%28${user}%29%20%5BVLESS%20-%20HTTPUpgrade%5D%20nonTLS"
...
🔑 VLess
a.) path HTTP Upgrade: /vless-http
...
echo -e "================================="
echo -e "path: "
echo -e "a.) HTTP Upgrade: /vless-http"
echo -e "================================="
echo -e "alpn: http/1.1"
echo -e "tls: true (tls), false (nontls)"
