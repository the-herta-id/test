...
show_vless_menu() {
    ...
    echo -e "${BB}————————————————————————————————————————————————————————${NC}"
    echo -e " ${MB}[1]${NC}•${LIGHT}Add Vless Ws${NC}"
    echo -e " ${MB}[2]${NC}•${LIGHT}Add Vless Grpc${NC}"
    echo -e " ${MB}[3]${NC}•${LIGHT}Add Vless Http Upgrade${NC}"
    echo -e " ${MB}[4]${NC}•${LIGHT}Add Vless TCP${NC}"
	echo -e " ${MB}[5]${NC}•${LIGHT}Add Vless Bundle${NC}"
...
handle_vless_menu() {
    ...
    case $opt in
        ...
        7) clear ; menu-akun ;;		
        0) clear ; menu ;;
        *) echo -e "${YB}Invalid input${NC}" ; sleep 1 ; show_vless_menu ;;
    esac
}
