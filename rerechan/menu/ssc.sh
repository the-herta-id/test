...
show_ShadowSock_menu() {
    clear
    echo -e "${BB}————————————————————————————————————————————————————————${NC}"
    echo -e "            ${WB}----- [ ShadowSock Menu ] -----${NC}            "
    echo -e "${BB}————————————————————————————————————————————————————————${NC}"
    echo -e " ${MB}[1]${NC}•${LIGHT}Add ShadowSock Ws${NC}"
    echo -e " ${MB}[2]${NC}•${LIGHT}Add ShadowSock Grpc${NC}"
    echo -e " ${MB}[3]${NC}•${LIGHT}Add ShadowSock Outline${NC}"
	echo -e " ${MB}[4]${NC}•${LIGHT}Add ShadowSock Bundle${NC}"
	echo -e " ${MB}[5]${NC}•${LIGHT}Add Trial${NC}"
	echo -e " ${MB}[6]${NC}•${LIGHT}Menu Utilities${NC}"
    echo -e ""
...
handle_ShadowSock_menu() {
    ...
    case $opt in
        ...
        6) clear ; menu-akun ;;		
        0) clear ; menu ;;
        *) echo -e "${YB}Invalid input${NC}" ; sleep 1 ; show_ShadowSock_menu ;;
    esac
}
