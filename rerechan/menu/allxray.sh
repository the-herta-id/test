...
show_allxray_menu() {
    ...
    echo -e "${BB}————————————————————————————————————————————————————————${NC}"
    echo -e " ${MB}[1]${NC}•${LIGHT}All Vpn${NC}"
    echo -e " ${MB}[2]${NC}•${LIGHT}Add Vmess${NC}"
    echo -e " ${MB}[3]${NC}•${LIGHT}Add Vless${NC}"
    echo -e " ${MB}[4]${NC}•${LIGHT}Add Trojan${NC}"
	echo -e " ${MB}[5]${NC}•${LIGHT}Add Shadow${NC}"
