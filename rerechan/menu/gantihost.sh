...
# Check dan install sqlite3 jika belum ada
...
# Backup database
cp /var/lib/marzban/db.sqlite3 /var/lib/marzban/db.sqlite3.backup

# Update semua address di tabel hosts
sqlite3 /var/lib/marzban/db.sqlite3 <<EOF
UPDATE hosts SET address = '$DOMAIN' WHERE address = '{SERVER_IP}';
EOF

# Verifikasi perubahan
echo "Domain setelah diupdate:"
sqlite3 /var/lib/marzban/db.sqlite3 "SELECT DISTINCT address FROM hosts;"

# Restart Marzban
marzban restart

echo "Update domain selesai dan Marzban telah direstart"