...
🔑 ShadowSocks 
a.) serviceName GRPC: shadowsocks-service

Config URL :

-==============================-

1.) Shadowsocks-GRPC TLS 
${linkss4}

-==============================-

Format Openclash : 
TIDAK SUPPORT DI OPENCLASH LUR, SILAHKAN GUNAKAN DI PASSWALL1 ATAU PASSWALL2
...
echo -e "================================="
echo -e "network: grpc"
echo -e "serviceName GRPC: shadowsocks-service"
echo -e "alpn: h2"
echo -e "================================="
echo -e "tls:"
echo -e "a.) GRPC: true"
