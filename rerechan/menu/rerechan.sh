...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "                  ${WB}»»» About Script «««${NC}  "
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
echo -e "Harga Untuk 1 Bulan 1 IP Address Tanpa Menu Routing : 15K" | lolcat
echo -e "  Harga Untuk 1 Bulan 1 IP Address + Menu Routing : 25K" | lolcat
echo -e "                   ${WH}KONTAK REGISTRASI${NC}"
echo -e "${YB}    |Telegram: @project_rerechan | WhatsApp: 083120684925|${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo ""
