...
🔑 ShadowSocks 
a.) path WS: /shadowsocks atau /custom-path/shadowsocks
b.) path WS Antiads: /shadowsocks-antiads
c.) path WS Anti ADS&PORN: /shadowsocks-antiporn
...
echo -e "c.) WS Anti Ads & porn: /shadowsocks-antiporn"
echo -e "================================="
